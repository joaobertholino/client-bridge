...
public class TransactionController {
	...
	@ApiResponses({
			...
			@ApiResponse(responseCode = "404", description = "Customer was not found in the database.", content = {@Content(schema = @Schema(implementation = ExceptionResponse.class), mediaType = "application/json")}),
